...
public abstract class Tank {
    public enum Ammo {
        NONE(0, 0),
        BULLET(5, 999),      // damage, shots in magazine (999 = infinite)
        SHOTGUN(3, 3),       // 3 damage, 3 shots then reload
        MISSILE(15, 1);      // 15 damage, 1 shot then reload
    ...
    public boolean canFire() {
        ...
        if (_ammo.getMagazineSize() == 999) return true; // Infinite ammo
        return ammoCount > 0;
    }
